...
void Report(bool runSerial, int threads, int chunkSize, bool verify, int** pts, int dimX, int dimY, double ptime, int maxIterations, double *Window, bool success);
...
int main(int argc, char* argv[]) 
{
    ...
    Report(runSerial, numThreads, chunkSize, verify, image, imgX, imgY, pTime,maxIterations,Window,success);
