...
void Report(bool runSerial, int numThreads, int chunkSize, bool verify, int** pts, int dimX, int dimY, double Tp, int maxIterations, double *Window, bool success)
